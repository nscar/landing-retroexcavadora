...
const items = [
  ...
  { titulo: 'Combustible incluido', desc: 'Llegas, arrancás, devolvés. Sin cargos extra.' },
        ...
        <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {items.map((it) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-brand-ink">{it.titulo}</h3>
              <p className="text-body text-gray-700">{it.desc}</p>
            </li>
          ))}
        </ul>
      </div>
